...
export const BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3000'; // Fallback for local development

//export const CREATE_ORDER = `${BASE_URL}/api/orders/create`;
export const CREATE_UPI_ORDER = `${BASE_URL}/api/orders/create-upi`;
